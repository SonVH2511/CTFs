...
# __tmp = (comp[-2] << 64) | comp[-1]
# print(hex(__tmp))
# out = outPut(__tmp)
# for i in out:
#     print(hex(i), end=" ")

# enc_flag = [252, 177, 199, 148, 208, 126, 89, 13, 191, 22, 62, 252, 171, 70, 253,
#             242, 229, 160, 252, 250, 23, 103, 60, 231, 1, 73, 218, 251, 215, 40, 152, 69]
# enc_flag = [16, 104, 225, 229, 238, 249, 43, 44, 3, 89, 91, 167, 59, 197, 166, 190, 197, 216, 59, 30, 207, 132, 210,
#             149, 110, 63, 210, 49, 211, 248, 172, 182, 27, 105, 76, 34, 46, 40, 147, 229, 167, 236, 112, 11, 71, 254, 158, 78]
# __out = [0]*8
# j = 0
